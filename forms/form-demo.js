...
function validateForm(event) {
    ...
    const fullNameInput = theForm.querySelector("[name='fullName']");
    if (fullNameInput && fullNameInput.value !== "Bob") {
        isValid = false;
        errors.push("Your name is not Bob");
    }
    if (theForm.paymentMethod && theForm.paymentMethod.value === "creditCard") {
        if (theForm.creditCardNumber.value !== "1234123412341234"){ //theForm.creditCardNumber &&
            isValid = false;
